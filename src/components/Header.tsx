...
import { WeatherWidget } from './WeatherWidget' // WeatherWidget'ı import et
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            <WeatherWidget /> {/* <-- BURAYA EKLE */}
            <div className="w-px h-6 bg-gray-300 dark:bg-gray-700"></div> {/* Ayırıcı Çizgi */}
            <ThemeSwitcher />
          </div>
        </div>
      </div>
